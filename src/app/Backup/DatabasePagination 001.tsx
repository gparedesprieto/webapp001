...
function convertirJsonAString(json: Record<string, string>): string {
...
const fetchPaginatedData = async (page, pageSize, sortModel, filterModel, valueFiltro) => {
...
const DatabasePagination = ({ triggerReload, valueFiltro, onSeleccionUsuario }: DataPaginationProps) => {
