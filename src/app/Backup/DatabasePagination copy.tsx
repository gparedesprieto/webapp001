...
const token = "..En6q1Bkkz53dj3QFV90MeI_ZT9WLpHDxc5ckApAoIbgrTDdohr6IeE4ybxvBWJRm4yfZsKYH_WRjrd5vytSH-MrxrdsWHGKCSOMZDhv0rvgdkjjZJps8OIRWxt2B-EcllqE7zGIc4DT3RVH3Kqvs1UG40Y5IgkUrtxPbWg6DFB16uEAnB8_Ns9J0KfLYREspVfXMsOYSwZ0xWuqjfgkVHIFkhRCgbiXrz8lTe7yqvuComkZeoaTf3TpPXcFxBNh2TcEYC_sDz08uieQoW0KvAW4KVaP3KBM98h6sM1RdtyAu1x7mPKlY_LVkId9V6knqfzMBMUCn4a1J68PNWt3vEA";
...
const fetchPaginatedData = async (page, pageSize, sortModel, filterModel) => {
    ...
    console.log(fieldValuePairs); // "id=1,nombres=2,email=3,department=4,salary=5,createdAt=6"
    ...
    const input = {
        payload: {
            ...
            filtros: fieldValuePairs
        }
    };
  
    const res = await fetch("https://localhost:8243/seguridad/v1/UsuarioPaginaFiltro", {
        method: 'POST',
        headers: {
    ...
    let dataRows = 0;
    //console.dir(data.Usuarios.Usuario)
    if (!Array.isArray(data?.Usuarios?.Usuario) || data.Usuarios.Usuario.length === 0) {
      console.log("No hay usuarios");
      paginatedData = [];
    }
    else {
      paginatedData = data.Usuarios.Usuario;
      dataRows = data.Usuarios.Usuario[0].total_count;
    } 
